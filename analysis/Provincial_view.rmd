...
employment_by_industury_table_number <- "14-10-0202-01"
...
#### employment by indusury 

```{r employment by industry}
employment_by_industury <- cansim::get_cansim_ndm(employment_by_industury_table_number)
employment_by_industury <- janitor::clean_names(employment_by_industury_table_number)

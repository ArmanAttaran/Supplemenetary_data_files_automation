...
#### [**Actual hours worked by industry, annual**](https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1410003701&pickMembers%5B0%5D=1.1&pickMembers%5B1%5D=2.1&pickMembers%5B2%5D=3.2&pickMembers%5B3%5D=5.1&cubeTimeFrame.startYear=2016&cubeTimeFrame.endYear=2020&referencePeriods=20160101%2C20200101)
...
LFS_hoursworked %>%
  ...
  filter( sex == "Both sexes" ) %>% 
  pivot_wider(names_from = actual_hours_worked , values_from = value) %>% interactive_table()
...
employment_by_industury %>%
  ...
  mutate_at(vars(), list(\~ .x - lag(.x))) %>% View()
interactive_table()
  filter(geo %in% provinces) %>%

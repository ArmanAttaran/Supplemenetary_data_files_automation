...
-   version \#2
    ...
    -   take the absolute value of CPC add one to it and then square it and average it by province.
        ...
        -   this is because in version \#1 if a CPC is below 1 (which it usually is) it would decrease the metric after squaring it; I think this is against the spirit of the metric.
